...
import { CIntentText, FormContainer, LSButtonContainer, CGridRow, CTextField, CTitle, CText, CLabel, MLinkBold, TextGroup} from './Style';
import { LSButton,LSBlueTextButton } from './Style';
    ...
    <ThemeProvider theme={settingPage}>
      ...
      <FormContainer>
        ...
        <TextGroup>
          ...
          <MLinkBold href='#'>{' Contact'}</MLinkBold>
        </TextGroup>
      </Box>
    </ThemeProvider>
  );
