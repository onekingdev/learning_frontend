...
`
export const LSDialogActions = styled(DialogActions)`
display: flex;
...
margin: 15px;
`
export const MLinkBold = styled(Link)`
font-family: Montserrat;
font-size: 16px;
font-style: normal;
font-weight: 600;
...
`
export const FormContainer = styled(ShadowContainer)`
width: 624px;
left: 303px;
top: 312px;
font-family: Montserrat;
`
export const MemContainer = styled(ShadowContainer)`
// height: 546px;
width: 683px;
left: 960px;
top: 312px;
...
font-family: Montserrat;
`
export const CTitle = styled.label`
font-family: Montserrat;
font-size: 24px;
margin-top: 0px;
margin-bottom: 10px;
