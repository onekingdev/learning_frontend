...
const ProcessPath10Svg: FC<IProcessPathSvg> = ({
    ...
    return (
        <svg width="75" height="117" viewBox="0 0 75 117" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
...
const ProcessPath19Svg: FC<IProcessPathSvg> = ({
    ...
    return (
        <svg width="131" height="97" viewBox="0 0 131 97" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
...
const ProcessPath27Svg: FC<IProcessPathSvg> = ({
    ...
    return (
        <svg width="79" height="141" viewBox="0 0 79 141" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
...
const ProcessPath41Svg: FC<IProcessPathSvg> = ({
    ...
    return (
        <svg width="79" height="140" viewBox="0 0 79 140" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <Container>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    { subSubjects.map((subSubject) => <span style={{
                        position: 'absolute',
                        transform: `rotate(${subSubject.angle}deg) translate(${subSubject.tX}px, ${subSubject.tY}px)`,
                        left: `${subSubject.left}px`,
                        top: `${subSubject.top}px`,
                        fontSize: "14px",
                        fontWeight: subSubject.active ? "600" : "400",
                        width: `${subSubject.width}px`,
