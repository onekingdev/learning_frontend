...
import { Title, Tip, Container, Welcome, Socrates, PaperContainer} from './Style'
                ...
                <Paper elevation={3} className={classes.paper} >
                    ...
                    <Grid container spacing={3}>
                        <Grid item xs={12}>
                            ...
                            <FormControl fullWidth>
                                ...
                                <Select
                                    ...
                                    className={`${classes.select} ${packageName === 'Gold'  ? classes.goldInput : packageName === 'Combo' ? classes.comboInput : classes.soleInput} err-border`}
                                    onChange={(e) => {
                                        setPackageName(e.target.value);
                                        setPaths([]);
                                        handleFormChange('packageName',e.target.value.length === 0 ? 'Field is required' : '');
                                    }}
                                    sx={validateMsg.packageName ? {'& fieldset':{borderColor: `${BasicColor.red} !important`}} : {}}
                                    displayEmpty={true}
                                >
                        ...
                        {packageName &&
                            <Grid item xs={12}>
                                <Subjects color={packageName}>
                                    <Subject>
                                        {packageName === 'Gold' && (<SubjectIcon src={math_gold} />)}
                                        {packageName === 'Combo' && (<><Checkbox sx={{color: BasicColor.aqua,'&.Mui-checked': {color: BasicColor.aqua,},padding:'0px',paddingLeft: '9px', paddingRight: '9px'}} onChange={ (e) => handleCheckPath('Math', e.target.checked) } checked={paths.indexOf('Math') !== -1} /><SubjectIcon src={math_combo} /></>)}
                                        {packageName === 'Sole' && (<><Radio value={'Math'} onClick={() => setPaths(['Math'])} checked={paths[0] === 'Math'} sx={{color: BasicColor.greenSoft,'&.Mui-checked': {color: BasicColor.greenSoft,},padding:'0px',paddingLeft: '9px', paddingRight: '9px'}}/><SubjectIcon src={math_sole} /></>)}
                                        <SubjectTitle>MATH</SubjectTitle>
                                    </Subject>
                                    <Subject>
                                        {packageName === 'Gold' && (<SubjectIcon src={ela_gold} />)}
                                        {packageName === 'Combo' && (<><Checkbox sx={{color: BasicColor.aqua,'&.Mui-checked': {color: BasicColor.aqua,},padding:'0px',paddingLeft: '9px', paddingRight: '9px'}} onChange={ (e) => handleCheckPath('Ela', e.target.checked) } checked={paths.indexOf('Ela') !== -1} /><SubjectIcon src={ela_combo} /></>)}
                                        {packageName === 'Sole' && (<><Radio value={'Ela'} onClick={() => setPaths(['Ela'])} checked={paths[0] === 'Ela'} sx={{color: BasicColor.greenSoft,'&.Mui-checked': {color: BasicColor.greenSoft,},padding:'0px',paddingLeft: '9px', paddingRight: '9px'}}/><SubjectIcon src={ela_sole} /></>)}
                                        <SubjectTitle>ELA + SIGHT WORDS</SubjectTitle>
                                    </Subject>
                                    <Subject>
                                        {packageName === 'Gold' && (<SubjectIcon src={science_gold} />)}
                                        {packageName === 'Combo' && (<><Checkbox sx={{color: BasicColor.aqua,'&.Mui-checked': {color: BasicColor.aqua,},padding:'0px',paddingLeft: '9px', paddingRight: '9px'}} onChange={ (e) => handleCheckPath('Science', e.target.checked) } checked={paths.indexOf('Science') !== -1} /><SubjectIcon src={science_combo} /></>)}
                                        {packageName === 'Sole' && (<><Radio value={'Science'} onClick={() => setPaths(['Science'])} checked={paths[0] === 'Science'} sx={{color: BasicColor.greenSoft,'&.Mui-checked': {color: BasicColor.greenSoft,},padding:'0px',paddingLeft: '9px', paddingRight: '9px'}}/><SubjectIcon src={science_sole} /></>)}
                                        <SubjectTitle>SCIENCE</SubjectTitle>
                                    </Subject>
                                    <Subject>
                                        {packageName === 'Gold' && (<SubjectIcon src={financial_gold} />)}
                                        {packageName === 'Combo' && (<><Checkbox sx={{color: BasicColor.aqua,'&.Mui-checked': {color: BasicColor.aqua,},padding:'0px',paddingLeft: '9px', paddingRight: '9px'}} onChange={ (e) => handleCheckPath('Financial', e.target.checked) } checked={paths.indexOf('Financial') !== -1} /><SubjectIcon src={financial_combo} /></>)}
                                        {packageName === 'Sole' && (<><Radio value={'Financial'} onClick={() => setPaths(['Financial'])} checked={paths[0] === 'Financial'} sx={{color: BasicColor.greenSoft,'&.Mui-checked': {color: BasicColor.greenSoft,},padding:'0px',paddingLeft: '9px', paddingRight: '9px'}}/><SubjectIcon src={financial_sole} /></>)}
                                        <SubjectTitle>FINANCIAL LITERACY</SubjectTitle>
                                    </Subject>
                                    <Subject>
                                        {packageName === 'Gold' && (<SubjectIcon src={health_gold} />)}
                                        {packageName === 'Combo' && (<><Checkbox sx={{color: BasicColor.aqua,'&.Mui-checked': {color: BasicColor.aqua,},padding:'0px',paddingLeft: '9px', paddingRight: '9px'}} onChange={ (e) => handleCheckPath('Health', e.target.checked) } checked={paths.indexOf('Health') !== -1} /><SubjectIcon src={health_combo} /></>)}
                                        {packageName === 'Sole' && (<><Radio value={'Health'} onClick={() => setPaths(['Health'])} checked={paths[0] === 'Health'} sx={{color: BasicColor.greenSoft,'&.Mui-checked': {color: BasicColor.greenSoft,},padding:'0px',paddingLeft: '9px', paddingRight: '9px'}} /><SubjectIcon src={health_sole} /></>)}
                        ...
                        <Grid item xs={12} md={12} lg={6}>
                            {childIdx > 0 &&(<Button value="Previous Kid" bgColor={ButtonColor.create} onClick={handlePrev}/>)}
                        </Grid>
                        <Grid item xs={12} md={12} lg={6}>
