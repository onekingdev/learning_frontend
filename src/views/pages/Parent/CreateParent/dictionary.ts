export const dictionary: any = Object.freeze({
    ...
    'es-mx': {
        ...
        byClickingCreateAccountYouAgreeToLearnWithSocrates: "Al hacer clic en Crear cuenta, aceptas",
        privacyPolicy: 'la Política de privacidad',
        termsAndConditions: 'Términos y condiciones',
        and: 'y',
        childrenPrivacyPolicy: 'Política de Privacidad para niños de Learn With Socrates',
        welcome: 'Bienvenido',
