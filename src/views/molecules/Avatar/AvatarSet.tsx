...
export const AvatarSet: FC<AvatarProps> = ({
  ...
  return (
    <CurrentAvatar>
      <div className='accessory' style={accessory ? {} : { display: 'none' }}>
        <AvatarWithSkinTone url={accessory} skinTone={2} />
      </div>
      <div className='header' style={head ? {} : { display: 'none' }}>
        <AvatarWithSkinTone url={head} skinTone={2} />
      </div>
      <div className='body' style={body ? {} : { display: 'none' }}>
        <AvatarWithSkinTone url={body} skinTone={2} />
      </div>
      <div className='pants' style={pants ? {} : { display: 'none' }}>
        <AvatarWithSkinTone url={pants} skinTone={2} />
      </div>
    </CurrentAvatar>
  );
};
