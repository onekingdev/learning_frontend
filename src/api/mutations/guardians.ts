...
export const CREATE_ORDER = (
    ...
    createOrder(discount: ${discount}, discountCode: "${discountCode}", guardianId: ${guardianId}, orderDetailInput: ${orderDetailInput}, paymentMethod: "${paymentMethod}", returnUrl: "${returnUrl}", subTotal: ${subTotal}, total: ${total}){
        order{
            ${ORDER}
        }
        status
